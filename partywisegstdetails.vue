    ...
    <div class="vx-card p-6" style="" >
     ...
     <tr>
      <td width="25%">
       ...
       <td width="50%"><center><h1>Party Wise Gst Details<br><h4><font color="blue">View</font></h4></h1></center></td>
...
<div id="page-wrap">
    ...
    <table border="0"  cellspacing="5" class="tables">
      ...
      <tr>
        <td class="overlap">State</td>
        <td><vs-input class="w-full" size="small" v-model="input1" /></td>
      </tr>
      <tr>
        <td class="overlap">Agent</td>
        <td><vs-input class="w-full" size="small" v-model="input1" /></td>
      </tr>
    ...
    <div id="rights">
      <table border="0" cellspacing="5"  class="tables" >
      <tr>
         <td class="overlap">List Sale/Pur</td>
          <td>
      ...
      <tr>
         <td class="overlap">Date Condition</td>
          <td>
             <select class="w-full selectp">
            <option value=""></option>
          </select>
      ...
      <tr>
         <td class="overlap">Report Type</td>
          <td>
             <select class="w-full selectp">
            <option value=""></option>
          </select>
