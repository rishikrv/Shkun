    ...
    <div class="vx-card p-6" style="" >
     ...
     <tr>
      <td width="25%">
       ...
       <td width="50%"><center><h1>Sale SALE GST<br><h4><font color="blue">View</font></h4></h1></center></td>
        ...
        <tr>
            <td width="30%" align="left">
                ...
                <td>
                    ...
                    <input type="checkbox"> Grab Challan
                </td>
...
<br>
	...
	<div id="page-wrap">
      ...
      <table border="0" width="100%" cellspacing="5" class="tables">
        <tr>
          <td class="overlap"></td>
          <td><input type="checkbox"> <font color="red">Late Payment Alert</font></td>
        </tr>
        <tr>
...
<table id="customers" style="empty-cells:hide;">
  ...
  <tr>
    ...
    <table border="0"  cellspacing="5" class="tables"  style="padding-top:8%;">
      <tr>
        <td class="overlap">Shipped To</td>
        <td><vs-input class="w-full" size="small" v-model="input1" /></td>
      </tr>
      <tr>
    ...
    <table border="0"  cellspacing="5" class="tables" style="padding-top:8%;">
      <tr>
        <td class="overlap"><font color="red">Adjust Advance Rs.</font></td>
        <td><vs-input class="w-full" size="small" v-model="input1" /></td>
      </tr>
      <tr>
        <td class="overlap"><font color="red">Total GST</font></td>
        <td><vs-input class="w-full" size="small" v-model="input1" /></td>
      </tr>
    ...
    <table border="0"  cellspacing="5" class="tables" style="padding-top:8%;">
      ...
      <tr>
        <td class="overlap">Exp. After Gst</td>
        <td><vs-input class="w-full" size="small" v-model="input1" /></td>
      </tr>
      <tr>
        <td class="overlap"><font color="red">Grand Total</font></td>
        <td><vs-input class="w-full" size="small" v-model="input1" /></td>
      </tr>
      ...
      <div align="right" style="padding-top: 220px">
      <br>
