    ...
    <div class="vx-card p-6" style="" >
     ...
     <tr>
      <td width="25%">
       ...
       <td width="50%"><center><h1>Production Register<br><h4><font color="blue"></font></h4></h1></center></td>
	...
	<div id="page-wrap" >
      ...
      <table border="0" width="100%" cellspacing="5" class="tables">
        ...
        <tr>
          ...
          <td  class="right" ><vs-button  color="primary" type="filled">Exit</vs-button></td>
        </tr>
        <tr>
         
          <td><vs-button  color="primary" type="filled">Print</vs-button></td>
        </tr>
