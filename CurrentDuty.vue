...
<template>
    ...
    <table border="0" width="100%" class="tables">
        ...
        <tr>
            <td width="20%" align="left">
                <table border="0"  class="tables" align="left"><br>
 ...
 <div align="left" style="padding-top: 10px">
      ...
      <div class="right" align="left">
        ...
        &nbsp;
        <vs-button  color="primary" type="filled" style="!">View</vs-button>
        &nbsp;
...
<div>
	<table width="100%" border="0">
        <tr>
          ...
          <td class="overlap">With Average Stock Value</td>
            
        </tr>
	</table>

    <table width="100%" border="1" class="tables"  style="padding-top: 5px">
    
      
       <tr ><center><h3>Current Duty / Stock Chart</h3></center></tr>
