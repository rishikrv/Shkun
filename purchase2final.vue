    ...
    <div class="vx-card p-6" style="" >
     ...
     <tr>
      <td width="25%">
       ...
       <td width="50%"><center><h1>Purchase .2<br><h4><font color="blue">View</font></h4></h1></center></td>
  ...
  <tr>
   ...
   <tr>
    ...
    <div id="page-wrap">
      ...
      <table border="0" width="100%" cellspacing="5" class="tables">
        <tr>
          <td class="overlap">GSTR 2A Status</td>
      ...
      <table border="0" width="100%" cellspacing="5" class="tables">
        <tr>
          <td class="overlap">Adjust Advance</td>
          <td><vs-input class="w-full" size="small" v-model="input1" /></td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="overlap">C.Cess</td>
          <td><vs-input class="w-full" size="small" v-model="input1" /></td>
        </tr>
        <tr>
          <td class="overlap">H.Cess</td>
          <td><vs-input class="w-full" size="small" v-model="input1" /></td>
        </tr>
