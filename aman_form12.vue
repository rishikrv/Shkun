    ...
    <div class="vx-card p-6" style="" >
     ...
     <tr>
      <td width="25%">
       ...
       <td width="50%"><center><h1>Product Wise Sale<br><h4><font color="blue">Sale</font></h4></h1></center></td>
      ...
      <table width="100%" border="0" class="tables" cellspacing="5">
        ...
        <tr>
          <td>Broker <input type="checkbox">B2B</td>
          <td><vs-input class="w-full" size="small" v-model="input1" /></td>
        </tr>
        <tr>
        <tr>
      ...
      <table width="100%" border="0" class="tables" cellspacing="5">
        <tr>
        <td align="center">
         <vs-button  color="primary" type="filled" style="!">Select Agent</vs-button>
         </td>
         </tr>
         <tr>
           <td align="center">
