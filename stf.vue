...
<template>
    ...
    <div class="vx-card p-6" style="" >
     ...
     <tr>
      <td width="25%">
       ...
       <td width="50%"><center><h1>Stock Transfer<br><h4><font color="blue">View</font></h4></h1></center></td>
    ...
    <table border="0" width="100%" class="tables" >
        ...
        <td width="20%" table border="0"  align="right"  cellspacing="5" class="tables" >
          
        <tr>
          <td class="overlap"><b>Unit</b></td>
          <td>
